...
if isstr(crop)
    ...
    IAH=load([iddstring '/Irrigation/Seibert/processed_matfiles/AH_CROP'...
        CropNo '.mat']);
    
    RAH=load([iddstring '/Irrigation/Seibert/processed_matfiles/AH_CROP'...
        int2str(str2num(CropNo)+29) '.mat']);   
    
    IY=load([iddstring '/Irrigation/Seibert/processed_matfiles/'...
        'YIELD_CROP'  CropNo '_1998_2002.mat']);
    
    RY=load([iddstring '/Irrigation/Seibert/processed_matfiles/'...
    ...
    if numel(jj)==1
        ...
        IAHfor=load([iddstring '/Irrigation/Seibert/processed_matfiles/AH_CROP'...
            ForCropNo '.mat']);
        
        RAHfor=load([iddstring '/Irrigation/Seibert/processed_matfiles/AH_CROP'...
            int2str(str2num(ForCropNo)+29) '.mat']);
%         
%         IYfor=load([iddstring '/Irrigation/Seibert/processed_matfiles/'...
%             'YIELD_CROP'  ForCropNo '_1998_2002.mat']);
%         
%         RYfor=load([iddstring '/Irrigation/Seibert/processed_matfiles/'...
...
%         RYfor.Data=datablank;
    ...
    IG=load([iddstring '/Irrigation/Seibert/processed_matfiles/'...
        'ANNUAL_CWU_IRC_GREEN_05_MM_C'  CropNo '_1998_2002.mat']);
    
    RG=load([iddstring '/Irrigation/Seibert/processed_matfiles/'...
        'ANNUAL_CWU_RFC_GREEN_05_MM_C'  CropNo '_1998_2002.mat']);
    
    IB=load([iddstring '/Irrigation/Seibert/processed_matfiles/'...
        'ANNUAL_CWU_IRC_BLUE_05_MM_C'  CropNo '_1998_2002.mat']);
    
    RB=load([iddstring '/Irrigation/Seibert/processed_matfiles/'...
...
x={ ...
    ...
    'Groundnuts / Peanuts ','16','groundnut',...
    'Pulses ','17','pulses',...
    'Citrus ','18','citrus',...
    'Date palm ','19','date',...
