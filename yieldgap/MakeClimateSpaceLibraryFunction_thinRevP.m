function MakeClimateSpaceLibraryFunction_thinRevP(FlagStructure)
%% MakeClimateSpaceLibraryFunction_thinRevP   New Yield Gap Work - J. Gerber, N. Mueller
%
%  SYNTAX
...
%
%
%  April - 2014  I am redoing this but saving much smaller files. 
...
BinMatrixVector=BinMatrix(agrimasklogical);
InsideContourLogicalVector=InsideContourLogical(agrimasklogical);
save(FileName,'BinMatrixVector','ClimateDefs',...
    'PercentToDrop','WetFlag','HeatFlag',...
                    'CDS','InsideContourLogicalVector','GDDTempstr','ContourMask','xbins','ybins',...
                    'ContourStructure');
