    ...
    for jcrop=1:length(CropNames);
        for   jwf=[2];
            ...
            if exist([FileName '.mat'])==2
                ...
                % if file is very small and file is more than 1 minute
                % old, overwrite.
            ...
            if skipthisfile==1
                ...
                if isempty(GetBinsElsewhere)
                    ...
                    load([GetBinsElsewhere filesep NoBaseFileName],'CDS',...
                        'InsideContourLogicalVector','ContourMask','xbins','ybins',...
                        'ContourStructure');
                    InsideContourLogical=datablank;
                    InsideContourLogical(agrimasklogical)=InsideContourLogicalVector;
                end
