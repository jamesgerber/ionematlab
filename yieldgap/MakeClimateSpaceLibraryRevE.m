        ...
        for jwf=1:4;
          ...
          %          eval('Heat=GSL;');
            ...
            [GDDBinEdges,PrecBinEdges]= ...
                CalculateBins_GloballyEqualAreaSpace(Heat,Prec,CultivatedArea,N,PercentToDrop);
            ...
            DAS.Description='Climate Space Library, Revision E.  October 29, 2009';
