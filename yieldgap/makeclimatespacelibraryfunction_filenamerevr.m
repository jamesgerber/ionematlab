function MakeClimateSpaceLibraryFunctionRevR(FlagStructure)
...
for N=Nspace;
    for jcrop=1:length(CropNames);
        for   jwf=[ 2 4 5];
            ...
            [GDDTempstr,GDDTmaxstr]=GetGDDBaseTemp(cropname);
            GDDFileName=['GDDRev2_' GDDTempstr '_' GDDTmaxstr ];
            ...
            if DataYear==2000
                FileName=[SaveFileNameBaseDir '/ClimateMask_' cropname '_' HeatFlag  GDDTempstr '_' ...
                    'Tmax_' GDDTmaxstr '_' WetFlag '_' int2str(N) ...
                    'x' int2str(N) '_RevR'];
                
                NoBaseFileName=['/ClimateMask_' cropname '_' HeatFlag  GDDTempstr '_' ...
                    'Tmax_' GDDTmaxstr '_' WetFlag '_' int2str(N) ...
                    'x' int2str(N) '_RevR'];
            else
                FileName=[SaveFileNameBaseDir '/ClimateMask_' cropname '_' int2str(DataYear) '_' HeatFlag  GDDTempstr '_' ...
                    'Tmax_' GDDTmaxstr '_' WetFlag '_' int2str(N) ...
                    'x' int2str(N) '_RevR'];
                
                NoBaseFileName=['/ClimateMask_' cropname '_' int2str(DataYear) '_' HeatFlag  GDDTempstr '_' ...
                    'Tmax_' GDDTmaxstr '_' WetFlag '_' int2str(N) ...
                    'x' int2str(N) '_RevR'];
            end
            ...
            if exist([FileName '.mat'])==2
                ...
                if isempty(GetBinsElsewhere)
                    ...
                    [PrecBinEdges,GDDBinEdges,xbins,ybins,ContourMask,InsideContourLogical]= ...
                        CalculateBins_Globally_RevR(Prec,tempvar,...
