...
nsg((1-OS.YieldGapFraction),'title',[' fraction of attainable ' OS.cropname ' yield. ' ],...
    'cmap','nmstoplight','caxis',[-40 40],...
    'filename',[fileroot OS.cropname 'attainableyieldfraction'],...
    'colorbarpercent','on','resolution','-r600','eastcolorbar','on');
